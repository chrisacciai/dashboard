    ...
    constructor() {
      ...
      handleSubmit(e) {
        ...
        const monthDataPair = {
          ...
          lineFourValue1: parseInt(this.state.lineFourData1, radix),
          lineFourValue2: parseInt(this.state.lineFourData2), radix,
          month5: this.state.lineFiveMonth,
          lineFiveValue1: parseInt(this.state.lineFiveData1, radix),
          lineFiveValue2: parseInt(this.state.lineFiveData2, radix),
          month6: this.state.lineSixMonth,
          lineSixValue1: parseInt(this.state.lineSixData1, radix),
          lineSixValue2: parseInt(this.state.lineSixData2, radix),
        }
