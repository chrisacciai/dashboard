    ...
    constructor() {
      ...
      handleSubmit(e) {
        ...
        const monthDataPair = {
          ...
          value1: parseFloat(this.state.lineOneData, radix),
          month2: this.state.lineTwoMonth,
          value2: parseFloat(this.state.lineTwoData, radix),
          month3: this.state.lineThreeMonth,
          value3: parseFloat(this.state.lineThreeData, radix),
          month4: this.state.lineFourMonth,
          value4: parseFloat(this.state.lineFourData, radix),
          month5: this.state.lineFiveMonth,
          value5: parseFloat(this.state.lineFiveData, radix),
          month6: this.state.lineSixMonth,
          value6: parseFloat(this.state.lineSixData, radix),
          month7: this.state.lineSevenMonth,
          value7: parseFloat(this.state.lineSevenData, radix),
          month8: this.state.lineEightMonth,
          value8: parseFloat(this.state.lineEightData, radix),
          month9: this.state.lineNineMonth,
          value9: parseFloat(this.state.lineNineData, radix),
          month10: this.state.lineTenMonth,
          value10: parseFloat(this.state.lineTenData, radix),
          month11: this.state.lineElevenMonth,
          value11: parseFloat(this.state.lineElevenData, radix),
          month12: this.state.lineTwelveMonth,
          value12: parseFloat(this.state.lineTwelveData, radix),
