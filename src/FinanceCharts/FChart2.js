...
import {ResponsiveContainer, BarChart, Bar, XAxis, Tooltip, YAxis, CartesianGrid, LabelList, Legend} from 'recharts';
            ...
            <div>
              ...
              <p class="alignright">
                <ButtonGroup bsSize="xs">
                  ...
                  <Button onClick={this.show.bind(this)} type="submit" bsStyle="primary" form="form15">Submit Data</Button> 
                </ButtonGroup>
              </p>
            </div>
            <br/>
